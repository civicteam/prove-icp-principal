...
* @returns {string}
*/
module.exports.validateDelegationAndGetPrincipal = function(challenge, signed_delegation_chain_json, current_time_ns, ii_canister_id, ic_root_public_key_raw) {
    let deferred6_0;
    let deferred6_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
const path = require('path').join(__dirname, 'sig_verifier_js_bg.wasm');
